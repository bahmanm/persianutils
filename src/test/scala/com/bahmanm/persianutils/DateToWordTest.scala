...
class DateToWordTest extends munit.FunSuite {
  ...
  test("persian: all 12 Persian months") {
    assertEquals(
      DateToWord.persian(1400, 1, 1),
      "یکم فروردین یک هزار و چهار‌صد"
    )
    assertEquals(
      DateToWord.persian(1400, 2, 2),
      "دوم اردیبهشت یک هزار و چهار‌صد"
    )
    ...
    assertEquals(
      DateToWord.persian(1400, 11, 11),
      "یازدهم بهمن یک هزار و چهار‌صد"
    )
    assertEquals(
      DateToWord.persian(1400, 12, 12),
      "دوازدهم اسفند یک هزار و چهار‌صد"
    )
  }
  ...
  test("gregorian: all 12 Gregorian months in Persian") {
    assertEquals(
      DateToWord.gregorian(2026, 1, 1),
      "یکم ژانویه دو هزار و بیست و شش"
    )
    assertEquals(
      DateToWord.gregorian(2026, 2, 2),
      "دوم فوریه دو هزار و بیست و شش"
    )
    assertEquals(
      DateToWord.gregorian(2026, 3, 3),
      "سوم مارس دو هزار و بیست و شش"
    )
    assertEquals(
      DateToWord.gregorian(2026, 4, 4),
      "چهارم آوریل دو هزار و بیست و شش"
    )
    assertEquals(
      DateToWord.gregorian(2026, 5, 5),
      "پنجم مه دو هزار و بیست و شش"
    )
    assertEquals(
      DateToWord.gregorian(2026, 6, 6),
      "ششم ژوئن دو هزار و بیست و شش"
    )
    assertEquals(
      DateToWord.gregorian(2026, 7, 7),
      "هفتم ژوئیه دو هزار و بیست و شش"
    )
    assertEquals(
      DateToWord.gregorian(2026, 8, 8),
      "هشتم اوت دو هزار و بیست و شش"
    )
    assertEquals(
      DateToWord.gregorian(2026, 9, 9),
      "نهم سپتامبر دو هزار و بیست و شش"
    )
    assertEquals(
      DateToWord.gregorian(2026, 10, 10),
      "دهم اکتبر دو هزار و بیست و شش"
    )
    assertEquals(
      DateToWord.gregorian(2026, 11, 11),
      "یازدهم نوامبر دو هزار و بیست و شش"
    )
    assertEquals(
      DateToWord.gregorian(2026, 12, 12),
      "دوازدهم دسامبر دو هزار و بیست و شش"
    )
  }
  ...
  test("ordinal days representation") {
    assertEquals(
      DateToWord.persian(1390, 1, 1),
      "یکم فروردین یک هزار و سیصد و نود"
    )
    assertEquals(
      DateToWord.persian(1390, 1, 2),
      "دوم فروردین یک هزار و سیصد و نود"
    )
    assertEquals(
      DateToWord.persian(1390, 1, 3),
      "سوم فروردین یک هزار و سیصد و نود"
    )
    assertEquals(
      DateToWord.persian(1390, 1, 10),
      "دهم فروردین یک هزار و سیصد و نود"
    )
    assertEquals(
      DateToWord.persian(1390, 1, 20),
      "بیستم فروردین یک هزار و سیصد و نود"
    )
    assertEquals(
      DateToWord.persian(1390, 1, 21),
      "بیست و یکم فروردین یک هزار و سیصد و نود"
    )
    assertEquals(
      DateToWord.persian(1390, 1, 22),
      "بیست و دوم فروردین یک هزار و سیصد و نود"
    )
    assertEquals(
      DateToWord.persian(1390, 1, 23),
      "بیست و سوم فروردین یک هزار و سیصد و نود"
    )
    assertEquals(
      DateToWord.persian(1390, 1, 30),
      "سی\u200Cام فروردین یک هزار و سیصد و نود"
    )
    assertEquals(
      DateToWord.persian(1390, 1, 31),
      "سی و یکم فروردین یک هزار و سیصد و نود"
    )
  }
  ...
  test("parsed date strings conversion to words") {
    assertEquals(
      PersianDate("1392/09/24").toWords,
      "بیست و چهارم آذر یک هزار و سیصد و نود و دو"
    )
    assertEquals(
      GregorianDate("2013/12/15").toWords,
      "پانزدهم دسامبر دو هزار و سیزده"
    )
  }
  ...
  test("SimpleDate to words") {
    ...
    assertEquals(
      DateToWord.persian(simple),
      "سوم خرداد یک هزار و سیصد و شصت و یک"
    )
    assertEquals(
      DateToWord.gregorian(DateConverter.SimpleDate(1992, 12, 3)),
      "سوم دسامبر یک هزار و نه‌صد و نود و دو"
    )
  }
