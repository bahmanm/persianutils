...
object DateToWord {
   ...
   * @return Verbal Persian expression
   */
   ...
   * Converts a Persian date to Persian words.
   *
   * @param date Persian date as ConvertibleDate
   * @return Verbal Persian expression
   */
  ...
  /**
   * Converts a Persian date given year, month, and day components to Persian words.
   *
   * @param year  Calendar year
   * @param month Calendar month (1-indexed, 1 to 12)
   * @param day   Calendar day (1-indexed, 1 to 31)
   * @return Verbal Persian expression
   */
   ...
   * Converts a Gregorian date to Persian words.
   *
   * @param date Gregorian date as ConvertibleDate
   * @return Verbal Persian expression
   */
  ...
  /**
   * Converts a Gregorian date given year, month, and day components to Persian words.
   *
   * @param year  Calendar year
   * @param month Calendar month (1-indexed, 1 to 12)
   * @param day   Calendar day (1-indexed, 1 to 31)
